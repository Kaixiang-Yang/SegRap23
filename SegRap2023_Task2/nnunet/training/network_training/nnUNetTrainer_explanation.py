...
class nnUNetTrainer(NetworkTrainer):
    ...
    def process_plans(self, plans):
        ...
        self.batch_size = stage_plans['batch_size'] #2, Task032_PDDCA48为例
        self.net_pool_per_axis = stage_plans['num_pool_per_axis'] #[4, 5, 5]
        self.patch_size = np.array(stage_plans['patch_size']).astype(int) #[ 64 192 160]
        ...
        self.num_classes = plans['num_classes'] + 1  # background is no longer in num_classes #9+1=10
        self.classes = plans['all_classes'] #[1, 2, 3, 4, 5, 6, 7, 8, 9]
