...
class Customalgorithm():  # SegmentationAlgorithm is not inherited in this class anymore
    def __init__(self):
        ...
        """
        self.nii_path = 'Task002_SegRap2023/imagesTs'
        self.result_path = 'Task002_SegRap2023/result'
        self.nii_seg_file = None#'SegRap2023_002.nii.gz'
        self.weight = "./weight/"
    ...
    def load_inputs(self):      # use two modalities input data
        ...
        print(os.listdir('Task002_SegRap2023/imagesTs'))
