...
from nnunet.network_architecture.generic_UNet_CoT import Generic_UNet_CoT
from nnunet.paths import *


class ExperimentPlanner3D_CoT_v21(ExperimentPlanner):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_CoT_v21, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_v2.1"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNet_CoT_Plansv2.1_plans_3D.pkl")
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        ref = Generic_UNet_CoT.use_this_for_batch_size_computation_3D * self.unet_base_num_features / \
              Generic_UNet_CoT.BASE_NUM_FEATURES_3D
        here = Generic_UNet_CoT.compute_approx_vram_consumption(new_shp, network_num_pool_per_axis,
        ...
        batch_size = Generic_UNet_CoT.DEFAULT_BATCH_SIZE_3D  # This is what wirks with 128**3
