        ...
        for preprocessed in preprocessing:
            ...
            try:
                ...
                softmax = trainer.predict_preprocessed_data_return_seg_and_softmax(
                    d, do_mirroring=do_tta, mirror_axes=trainer.data_aug_params['mirror_axes'], use_sliding_window=True,#trainer.data_aug_params['mirror_axes']
...
def predict_from_folder_segrap2023(model: str, input_folder: str, output_folder: str, folds: 0, part_id:0, num_parts:1):
    ...
    expected_num_modalities = load_pickle(
        join(model+"/all", "plans.pkl"))['num_modalities']
    ...
    return predict_cases_segrap2023(model, list_of_lists[part_id::num_parts], output_files[part_id::num_parts], folds=folds)
